...
const SearchConnections = (props) => {
  ...
  const handleClose = value => {
	...
	return (
		<React.Fragment>
			<Fab color="default" aria-label="search" onClick={handleClickOpen} className={clsx(classes.connectionAvatar, "connectionAvatarHover")}>
				<SearchIcon />
			</Fab>
