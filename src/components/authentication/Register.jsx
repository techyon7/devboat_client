		...
		<form onSubmit={props.handleSubmit} className={classes.root}>
			...
			<Box width={1} display="flex" justifyContent="space-between">
				...
				<TextField
					...
					helperText={props.errors.firstName && props.touched.firstName ? props.errors.firstName : null}
				/>
				...
				<TextField
					...
					helperText={props.errors.lastName && props.touched.lastName ? props.errors.lastName : null}
				/>
			...
			{/* Password Input */}
			<FormControl fullWidth className={clsx(classes.margin, classes.textField)} error={props.errors.password && props.touched.password ? true : false}>
				...
				<InputLabel htmlFor="password">Password</InputLabel>
					...
					<Input
						...
						/>
						<FormHelperText>{props.errors.password && props.touched.password ? props.errors.password : null}</FormHelperText>
			</FormControl>


			{/* Password Confirmation Input */}
			<FormControl fullWidth className={clsx(classes.margin, classes.textField)} error={props.errors.confirmPassword && props.touched.confirmPassword ? true : false}>
				...
				<InputLabel htmlFor="confirmPassword">Confirm Password</InputLabel>
					...
					<Input
						...
						/>
						<FormHelperText>{props.errors.confirmPassword && props.touched.confirmPassword ? props.errors.confirmPassword : null}</FormHelperText>
			</FormControl>

			 {/* Sign up button container */}
			<Box width={1} align="center" mt={8}>
				{/* Sign up button */}
				<Button variant="contained" className={clsx(classes.margin, "btn btn-success")} type="submit">
					<Box px={8}>
						Sign up
					</Box>
				</Button>
